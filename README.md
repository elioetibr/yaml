...
The import path for the package is *github.com/elioetibr/yaml*.

To install it, run:

    go get github.com/elioetibr/yaml
...
If opened in a browser, the import path itself leads to the API documentation:
  ...
  - [https://github.com/elioetibr/yaml](https://github.com/elioetibr/yaml)
